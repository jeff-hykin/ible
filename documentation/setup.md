...
- (Don't git clone)
- Run this: `setup_or_copy=setup branch=master eval "$(curl -fsSL git@github.com:jeff-hykin/iilvd-online.git || wget -qO- git@github.com:jeff-hykin/iilvd-online.git)"`
...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`eval "$(curl -fsSL git@github.com:jeff-hykin/iilvd-online.git || wget -qO- git@github.com:jeff-hykin/iilvd-online.git)"`<br>[press enter]
    - Possible errors:
