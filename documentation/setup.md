...
- (Don't git clone)
- Run this: `setup_or_copy=setup branch=master eval "$(curl -fsSL https://github.com/jeff-hykin/iilvd-online || wget -qO- https://github.com/jeff-hykin/iilvd-online)"`
...
- Mac/Linux users
    ...
    - Type this inside your terminal/console <br>`eval "$(curl -fsSL https://github.com/jeff-hykin/iilvd-online || wget -qO- https://github.com/jeff-hykin/iilvd-online)"`<br>[press enter]
    - Possible errors:
