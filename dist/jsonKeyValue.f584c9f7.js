...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/edit-json-vue/src/jsonKeyValue.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    attemptToInformParent() {
      ...
      let valueChanged = this.previousValueAsString != newValueAsString; // if there is a legitimate change
    ...
    changeValue(newValue) {
      ...
      this.value = newValue; // tell the parent object to update
...
exports.default = _default;
  ...
  return _c(
    "jsonValue",
    {
      attrs: { initValue: _vm.value, isKeyed: "true" },
      on: { changeValue: _vm.changeValue, delete: _vm.deleteSelf }
    },
    [
      _c("input", {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c1a83a', $c1a83a);
          } else {
            api.reload('$c1a83a', $c1a83a);
          }
        }
